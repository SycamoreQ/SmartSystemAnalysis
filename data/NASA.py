...
feature_cols = [c for c in train.columns if c not in {"unit","cycle","RUL","state"}]
...
print("Saved:", MODELS_DIR / f"{FD}_features.txt",
      MODELS_DIR / f"{FD}_class_labels.txt",
      MODELS_DIR / f"{FD}_monitor_calibrated.joblib",
      MODELS_DIR / f"{FD}_P_y_given_c.csv")
